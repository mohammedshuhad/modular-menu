 ...
 *
 */
class SingleLineStringDisplayMenuItem : public MenuItem {
public:
    /**
     ...
     */
    SingleLineStringDisplayMenuItem(std::string title, StringMenuData &data, const ScrollResponse &scrollResponse);
